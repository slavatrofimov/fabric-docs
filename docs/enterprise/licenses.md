...
| Anyone can view Power BI items in workspaces hosted on a Power BI Premium Capacity or Fabric Capacity (of any size) when they're embedded using the [embed for your organization](/power-bi/developer/embedded/embed-sample-for-your-organization) method, embedded into Microsoft 365 apps ([Teams](/power-bi/collaborate-share/service-embed-report-microsoft-teams), [SharePoint](/power-bi/collaborate-share/service-embed-report-spo) or [PowerPoint](/power-bi/collaborate-share/service-power-bi-powerpoint-add-in-about)), or embedded using the [secure URL embedding](/power-bi/collaborate-share/service-embed-secure) method | :::image type="icon" source="../media/yes-icon.svg" border="false"::: | :::image type="icon" source="../media/yes-icon.svg" border="false"::: |:::image type="icon" source="../media/yes-icon.svg" border="false"::: |
